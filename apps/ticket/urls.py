...
from .views import TicketCreateView, TicketDeleteView, TicketDetailView, TicketMoveView, TicketUpdateView
...
urlpatterns = [
    ...
    path('<int:pk>/mover/', TicketMoveView.as_view(), name='mover_ticket'),
